...
O valor mínimo do saque é de 10 reais e o máximo de 600 reais.
...
os 5Qs 
o valor do saque do usuario 

infomar quantas notas de cada valor serao fornecidas a
; as notas são 1, 5, 10, 50 e 100 reais. O limite dos saques é
10 reais e o máximo de 600 reais.

usando um exemplo: Para sacar a quantia de 256 reais, o programa fornece duas notas de 100,
uma nota de 50, uma nota de 5 e uma nota de 1;

informa quantas notas de cada valor sera fornecidas 

5 pseudocodico falho
...
if (
    ...
    valor -= cinquenta * 50
    dez = valor // 10   # comentario MEU "esse cara é um genio"
    valor -= dez * 10
    cinco = valor // 5
    valor -= cinco * 5
...
# motas:  1, 5, 10, 50 e 100 reais.

# filtar a entrada
# ele vai separar os valores
# ex:
# 1024: 1000 - 20 - 4 
